...
# Menambahkan beberapa karyawan tetap
karyawan1 = KaryawanTetap("Rudy", 500000, "Keuangan", 100000)
karyawan2 = KaryawanTetap("Bian", 550000, "IT", 120000)

# Menambahkan beberapa karyawan harian
karyawan3 = KaryawanHarian("Salsa", 20000, "Gudang", 8)
karyawan4 = KaryawanHarian("Tika", 18000, "Produksi", 7)

# Menambahkan ke dalam manajemen
